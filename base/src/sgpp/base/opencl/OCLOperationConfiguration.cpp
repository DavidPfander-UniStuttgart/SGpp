...
std::unique_ptr<OCLOperationConfiguration> OCLOperationConfiguration::fromString(
    std::string &parametersString) {
  std::unique_ptr<OCLOperationConfiguration> parameters =
      std::make_unique<OCLOperationConfiguration>();
