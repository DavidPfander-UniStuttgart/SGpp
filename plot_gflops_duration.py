...
for level in [5, 6]:
    for dim in range(2, 11, 2):
        ...
        pylab.savefig("graphs/" + "gflops_gaussian_c" + str(clusters)  + "_" + args.device_name + "_" + args.precision + "_l" + str(level) + "_d" + str(dim) + ".png")
        pylab.clf()
        ...
        pylab.savefig("graphs/" + "duration_gaussian_c" + str(clusters)  + "_" + args.device_name + "_" + args.precision + "_l" + str(level) + "_d" + str(dim) + ".png")
        pylab.clf()
    ...
    for kernel_gflops in kernels_gflops:
        ...
        pylab.xlabel("dataset size")
        pylab.ylabel("GFLOPS (" + str(args.precision) + ")")
        pylab.savefig("graphs/" + "kernel_" + kernel_gflops + "_gflops_gaussian_c" + str(clusters) + "_" + args.device_name + "_" + args.precision + "_l" + str(level) + ".png")
        pylab.clf()
