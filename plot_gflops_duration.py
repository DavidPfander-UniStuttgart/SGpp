...
for dim in range(2, 11, 2):
    ...
    pylab.savefig("graphs/" + "gflops_gaussian_c" + str(clusters) + "_dim" + str(dim) + "_" + args.device_name + "_" + args.precision + ".eps")
    pylab.clf()
    ...
    pylab.savefig("graphs/" + "duration_gaussian_c" + str(clusters) + "_dim" + str(dim) + "_" + args.device_name + "_" + args.precision + ".eps")
    pylab.clf()
...
for kernel_gflops in kernels_gflops:
    ...
    pylab.savefig("graphs/" + "kernel_" + kernel_gflops + "_gflops_gaussian_c" + str(clusters) + "_" + args.device_name + "_" + args.precision + ".eps")
    pylab.clf()
