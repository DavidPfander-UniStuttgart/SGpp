...
./datadriven/examplesOCL/clustering_cmd --config config_ocl_float_P100.cfg --threshold=0.7 --datasetFileName paper_datasets/gaussian_c2_size100_dim10.arff --level=4 --lambda=0.00001 --k 5
