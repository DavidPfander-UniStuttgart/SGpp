...
k="5"
echo "k: k"
./datadriven/examplesOCL/clustering_cmd --datasetFileName $datasetFileName --level $level --lambda $lambda --threshold $threshold --k $k --config $config --write_graphs $scenarioName --density_eval_full_grid_level $eval_grid_level --refinement_steps 4 --refinement_points 10 --coarsen_points 999 --coarsen_threshold 0.01
...
./create_clustering_graphs.py --eval_grid_level $eval_grid_level --scenario_name $scenarioName --dataset_name $datasetFileName --use_unpruned_graph --dont_display_grid
./create_clustering_graphs.py --eval_grid_level $eval_grid_level --scenario_name $scenarioName --dataset_name $datasetFileName --dont_display_grid
./create_clustering_graphs.py --eval_grid_level $eval_grid_level --scenario_name $scenarioName --dataset_name $datasetFileName --dont_display_grid --dont_display_knn --dont_display_density
./create_clustering_graphs.py --eval_grid_level $eval_grid_level --scenario_name $scenarioName --dataset_name $datasetFileName --dont_display_data --dont_display_knn
