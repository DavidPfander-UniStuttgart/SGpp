...
mv ref_testing_grid_coord.csv results_diss/datadriven_ref_dim10id5_grid.csv
...
# special dim10id5 run to only obtain the grid, ARI is essentially 0
./datadriven/examplesOCL/clustering_cmd --datasetFileName datasets_diss/gaussian_c100_size100000_dim5id5_noise.arff --level 7 --epsilon 1E-2 --threshold 13000.0 --lambda 3.0E-8 --k 6 --config OCL_configs/config_ocl_float_QuadroGP100.cfg --write_cluster_map --file_prefix ref_testing --refinement_steps 5 --refinement_points 800 --write_density_grid > results_diss/clustering_adaptive_surplus_dim10id5.log 2>&1
mv ref_testing_grid_coord.csv results_diss/surplus_ref_dim10id5_grid.csv
