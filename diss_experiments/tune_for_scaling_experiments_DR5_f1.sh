...
./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 7 --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/friedman1_performance_multTranspose_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans false --level 7 --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/friedman1_performance_mult_double_${device_name_f1}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 7 --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/friedman1_performance_multTranspose_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    # compute performance of final parameters
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans false --level 7 --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/friedman1_performance_mult_float_${device_name_f1_cpu}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 7 --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/friedman1_performance_multTranspose_float_${device_name_f1_cpu}.log 2>&1
fi

# friedman1 - compute performance of final parameters ---------------------- duration

./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg

./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --trainingFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --grid.type ModLinear --grid.level 7 --operation.type STREAMING --operation.subType OCLUNIFIED --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true  --do_dummy_ocl_init --lambda 1E-5 > results_diss/unified/friedman1_performance_dur_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --combine_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg

    ./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/friedman1_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --trainingFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --grid.type ModLinear false --grid.level 7 --operation.type STREAMING --operation.subType OCLUNIFIED  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --do_dummy_ocl_init --lambda 1E-5 > results_diss/unified/friedman1_performance_dur_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    ./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_file results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg

    ./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/friedman1_${device_name_f1_cpu}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --trainingFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --grid.type ModLinear --grid.level 7 --operation.type STREAMING --operation.subType OCLUNIFIED --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --lambda 1E-5 > results_diss/unified/friedman1_performance_dur_float_${device_name_f1_cpu}.log 2>&1
fi
...
./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/DR5_performance_multTranspose_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/DR5_performance_mult_double_${device_name_f1}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/DR5_performance_multTranspose_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    # compute performance of final parameters
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/DR5_performance_mult_float_${device_name_f1_cpu}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions ${tuner_repetitions} --repetitions_averaged ${eval_repetitions} --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/unified/DR5_performance_multTranspose_float_${device_name_f1_cpu}.log 2>&1
fi

# DR5 - compute performance of final parameters ---------------------- duration

./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg

./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --trainingFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --grid.type ModLinear --grid.level 10 --operation.type STREAMING --operation.subType OCLUNIFIED  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true  --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement  --do_dummy_ocl_init --lambda 1E-5 > results_diss/unified/DR5_performance_dur_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --combine_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg

    ./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --trainingFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --grid.type ModLinear --grid.level 10 --operation.type STREAMING --operation.subType OCLUNIFIED  --solverFinal.maxIterations 300 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/unified/DR5_${device_name_f1}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --do_dummy_ocl_init --lambda 1E-5 > results_diss/unified/DR5_performance_dur_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    ./datadriven/examplesOCL/combined_configs --base_file results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_file results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --combine_prefixes TRANS KERNEL_TRANS --kernel_name StreamingModOCLUnified  --result_file results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg

    ./datadriven/examplesOCL/regression_cmd --additionalConfig results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --trainingFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --grid.type ModLinear --grid.level 10 --operation.type STREAMING --operation.subType OCLUNIFIED  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/unified/DR5_${device_name_f1_cpu}_weakscaling_parameters_combined_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --lambda 1E-5 > results_diss/unified/DR5_performance_dur_float_${device_name_f1_cpu}.log 2>&1
fi
