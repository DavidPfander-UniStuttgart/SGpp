...
./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans false --level 7  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true  --do_dummy_ocl_init --lambda 1E-5 > results_diss/friedman1_performance_mult_float_${device_name_f1}.log 2>&1

./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 7  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --do_dummy_ocl_init --lambda 1E-5 > results_diss/friedman1_performance_multTranspose_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans false --level 7  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --do_dummy_ocl_init --lambda 1E-5 > results_diss/friedman1_performance_mult_double_${device_name_f1}.log 2>&1

    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 7  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --do_dummy_ocl_init --lambda 1E-5 > results_diss/friedman1_performance_multTranspose_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    # compute performance of final parameters
    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans false --level 10  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --lambda 1E-5 > results_diss/friedman1_performance_mult_float_${device_name_f1_cpu}.log 2>&1

    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/friedman1_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/friedman/weakscaling_regression/friedman1_10d_200000.arff --isModLinear true --trans true --level 10  --solverFinal.maxIterations 100 --solverFinal.eps 0 --isRegression true --lambda 1E-5 > results_diss/friedman1_performance_multTranspose_float_${device_name_f1_cpu}.log 2>&1
fi
...
./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true  --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement  --do_dummy_ocl_init --lambda 1E-5 > results_diss/DR5_performance_mult_float_${device_name_f1}.log 2>&1

./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --do_dummy_ocl_init --lambda 1E-5 > results_diss/DR5_performance_multTranspose_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10  --solverFinal.maxIterations 300 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --do_dummy_ocl_init --lambda 1E-5 > results_diss/DR5_performance_mult_double_${device_name_f1}.log 2>&1

    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10  --solverFinal.maxIterations 300 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --do_dummy_ocl_init --lambda 1E-5 > results_diss/DR5_performance_multTranspose_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    # compute performance of final parameters
    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --lambda 1E-5 > results_diss/DR5_performance_mult_float_${device_name_f1_cpu}.log 2>&1

    ./datadriven/examplesOCL/regression_cmd --OpenCLConfigFile results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10  --solverFinal.maxIterations 500 --solverFinal.eps 0 --isRegression true --adaptConfig.support_refinement_min_support 500 --adaptConfig.support_refinement_ocl_config results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --adaptConfig.use_support_refinement --lambda 1E-5 > results_diss/DR5_performance_multTranspose_float_${device_name_f1_cpu}.log 2>&1
fi
