...
./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_mult_float_${device_name_f1}.log 2>&1

./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_multTranspose_float_${device_name_f1}.log 2>&1

if [ ${hn} != "argon-gtx" ]; then
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_mult_double_${device_name_f1}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_double_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_multTranspose_double_${device_name_f1}.log 2>&1
fi

if [ ${hn} = "argon-gtx" ]; then
    # compute performance of final parameters
    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_mult_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans false --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_mult_float_${device_name_f1_cpu}.log 2>&1

    ./datadriven/examplesOCL/regressionGFlops --OpenCLConfigFile results_diss/DR5_${device_name_f1_cpu}_weakscaling_parameters_multTrans_host_${hn}_tuner_line_search_t_float_10r_optimal.cfg --datasetFileName ../datasets/DR5/DR5_nowarnings_less05_train.arff --isModLinear true --trans true --level 10 --use_support_refinement --support_refinement_min_support 500  --repetitions 10 --operation.type STREAMING --operation.subType OCLUNIFIED > results_diss/DR5_performance_multTranspose_float_${device_name_f1_cpu}.log 2>&1
fi
