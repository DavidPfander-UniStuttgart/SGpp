...
./${cmd} >> results_diss/subspace/friedman1_subspace_wholescenario_${hn}_${device_name}.log
...
./${cmd} >> results_diss/subspace/DR5_subspace_wholescenario_${hn}_${device_name}.log
