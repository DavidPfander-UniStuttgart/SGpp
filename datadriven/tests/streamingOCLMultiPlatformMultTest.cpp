...
BOOST_FIXTURE_TEST_SUITE(TestStreamingOCLMultiPlatformMult,
                         TestStreamingOCLMultiPlatformMultFixture::FilesNamesAndErrorFixture)
...
BOOST_AUTO_TEST_CASE(SimpleSinglePrecision) {
  ...
  compareDatasets(fileNamesErrorFloat, sgpp::base::GridType::Linear, level, configuration);
}
