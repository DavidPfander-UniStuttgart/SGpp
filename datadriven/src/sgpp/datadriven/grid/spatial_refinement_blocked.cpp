...
void spatial_refinement_blocked::neighbor_pos_dir_blocked(
...
spatial_refinement_blocked::spatial_refinement_blocked(
...
std::vector<int64_t> &spatial_refinement_blocked::get_levels() {
  return levels;
}
std::vector<int64_t> &spatial_refinement_blocked::get_indices() {
  return indices;
}
...
void spatial_refinement_blocked::write_grid_positions(
