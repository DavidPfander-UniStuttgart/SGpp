...
int main(int argc, char **argv) {
  ...
  description.add_options()("help", "display help")(
      ...
      "print_cluster_sizes",
      boost::program_options::value<bool>(&print_cluster_sizes)
          ->default_value(false),
      "print the cluster sizes to stdout");
...

  {
    ...
    // for (size_t i = 0; i < clusters.size(); i += 1) {
    //   auto &cluster_indices = clusters[i];
